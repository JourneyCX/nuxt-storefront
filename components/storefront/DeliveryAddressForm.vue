...
<template>
  <div :style="{ backgroundColor: backgroundColor || '#ffffff', padding: '16px', border: '1px solid #e2e8f0', borderRadius: '10px' }">
    ...
    <!-- sb-grid (assets/css/responsive.css) stacks City/Postal Code/Country to
         1 column on mobile instead of squeezing three fields onto one row. -->
    <div class="sb-grid" style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin-bottom:12px">
      <div>
