...
// Live-render counterpart of studio-app's Functional/BlogPostDetail.tsx —
// assigned to a theme's "blog_post" slot (Store_theme_manager) and rendered
// by StorefrontRenderer when a tenant has one configured (see
// pages/blog/[slug].vue for the fallback to the previous hardcoded page when
// they don't). Data-fetching/rendering below is ported unchanged from that
// previous hardcoded page.
