...
import { fetchThemeCss, type ThemeCss } from '~/server/utils/stratum'
...
// boundary, so this adds no serial latency on a cache hit or miss. Graceful
// defaults (a brand-new tenant mid-provisioning, or a transient fetch
// failure) live in the composable now — see useSiteSettings.ts, shared with
// pages/preview/[theme].vue.
